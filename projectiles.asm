...
@set_sprite_frame:  
    ...
    ; Standard projectile
    lda #%00000000              ; 8x8 sprite, palette offset 0
    bra @write_mode
    
@rapid_sprite:
    lda #%00001001              ; 8x8 sprite, palette offset 1
    bra @write_mode
    
@spread_sprite:
    lda #%00001010              ; 8x8 sprite, palette offset 2
    bra @write_mode
    
@power_sprite:
    lda #%00001011              ; 8x8 sprite, palette offset 3
